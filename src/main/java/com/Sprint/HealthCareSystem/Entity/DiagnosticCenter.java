...
public class DiagnosticCenter {
	...
	private int did;
	@Column(name = "DiagC_Name", nullable = false, length = 10)
	private String name;
	@Column(name = "DiagC_ContactNo", nullable = false, length = 10)
	private String contactNo;
	@Column(name = "DiagC_Address", length = 20)
	private String address;
	@Column(name = "DiagC_Email", length = 10)
